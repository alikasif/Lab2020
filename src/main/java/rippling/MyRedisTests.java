...
public class MyRedisTests {
    ...
    @Test
    public void testTxnPutGet2() {
        ITransactionalKVStore transactionalKVStore = new TransactionalKVStore2();
        transactionalKVStore.set("1", "one");
        Assert.assertEquals("one", transactionalKVStore.get("1"));
    }

    @Test
    public void testTxnPutGetSingleTxnCommit2() {
        ITransactionalKVStore transactionalKVStore = new TransactionalKVStore2();
        transactionalKVStore.set("1", "one");
        transactionalKVStore.begin();
        transactionalKVStore.set("2", "two");
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testTxnPutGetSingleTxnRollback2() {
        ITransactionalKVStore transactionalKVStore = new TransactionalKVStore2();
        transactionalKVStore.set("1", "one");
        transactionalKVStore.begin();
        transactionalKVStore.set("2", "two");
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testTxnPutGetSingleTxnBeginEnd2() {
        ITransactionalKVStore transactionalKVStore = new TransactionalKVStore2();
        transactionalKVStore.set("1", "one");
        transactionalKVStore.begin();
        transactionalKVStore.set("2", "two");
    ...
    @Test
    public void testTxnPutGetSingleInnerBeginCommit2() {
        ITransactionalKVStore transactionalKVStore = new TransactionalKVStore2();
        transactionalKVStore.set("1", "one");
        transactionalKVStore.begin();
        transactionalKVStore.set("2", "two");
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testTxnPutGetSingleInnerBeginCommitOuterRollback2() {
        ITransactionalKVStore transactionalKVStore = new TransactionalKVStore2();
        transactionalKVStore.set("1", "one");
        transactionalKVStore.begin();
        transactionalKVStore.set("2", "two");
